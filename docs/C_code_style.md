...
- Every file (*header* or *source*) must start with `static char rcsid[] = "$Id$";`
...
This repository contains `confif/astyle-code-format.cfg` file which can be used with `AStyle` software.
