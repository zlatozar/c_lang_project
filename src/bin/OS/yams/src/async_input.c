...
static void
async_input_sigusr1(int signum)
{
  input_available_poller = 1;
}

static void
async_input_sigchld(int signum)
{
...
static void
async_input_sighandler(int signum)
{
  kill(async_input_sigpid, SIGTERM);
  exit(-1);
}
 ...
 */
int
async_input_register_fd(int fd)
{
