...
static int
nic_init_inet(char* name, int port, nicdevice_t* nic)
{
...
static int
nic_init_unix(char* name, int port, nicdevice_t* nic)
{
 ...
 */
int
nic_init(int domain, char* name, int port, int mtu, device_t* nic_dev)
{
  nicdevice_t* nic;
  int opt_true = 1;
  int flags;
...
int
nic_setreliability(int reliability, device_t* nic_dev)
{
  nicdevice_t* nic;
  nic = (nicdevice_t*)nic_dev->realdevice;
...
int
nic_sethwaddr(uint32_t hwaddr, device_t* nic_dev)
{
  nicdevice_t* nic;
  nic = (nicdevice_t*)nic_dev->realdevice;
...
/* returns: 0 - OK, 1 - invalid parameters */
int
nic_setdelays(int dma_delay, int send_delay, device_t* nic_dev)
{
  nicdevice_t* nic;
  nic = (nicdevice_t*)nic_dev->realdevice;
 ...
 */
int
nic_io_write(device_t* dev, uint32_t addr, uint32_t data)
{
  nicdevice_t* nic;
 ...
 */
int
nic_io_read(device_t* dev, uint32_t addr, uint32_t* data)
{
  if (dev == NULL || dev->realdevice == NULL) { return -1; } /* fatal */
