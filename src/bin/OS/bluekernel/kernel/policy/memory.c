...
int32_t
AddPageCall(pID_t pID, uint32_t virtual_address, uint32_t permissions)
{
  LockBus();
...
int32_t
MapPageCall(pID_t src_pID, uint32_t src_virtual_address,
            pID_t dst_pID, uint32_t dst_virtual_address, uint32_t permissions)
{
  LockBus();
...
int32_t
GrantPageCall(pID_t src_pID, uint32_t src_virtual_address,
              pID_t dst_pID, uint32_t dst_virtual_address, uint32_t permissions)
{
  LockBus();
...
int32_t
UnmapPageCall(pID_t pID, uint32_t virtual_address)
{
  LockBus();
...
int32_t
AddMemory(process_table_t* pID_ptr)
{
...
uint32_t
RemoveMemory(process_table_t* pID_ptr)
{
...
// @P+
int32_t
AddPage(process_table_t* pID_ptr, uint32_t virtual_address, uint32_t permissions)
{
...
int32_t
MapPage(process_table_t* src_pID_ptr, uint32_t src_virtual_address,
        process_table_t* dst_pID_ptr, uint32_t dst_virtual_address, uint32_t permissions)
{
  if (num_free_maps <= 0)
...
int32_t
GrantPage(process_table_t* src_pID_ptr, uint32_t src_virtual_address,
          process_table_t* dst_pID_ptr, uint32_t dst_virtual_address,
          uint32_t permissions)
{
...
int32_t
UnmapPage(process_table_t* pID_ptr, uint32_t virtual_address)
{
  int j;
...
int
RemoveMappings(uint32_t physical_page)
{
...
int32_t
CheckPageOwner(process_table_t* pID_ptr, int32_t physical_page)
{
...
int32_t
CheckRange(process_table_t* pID_ptr, uint32_t virtual_address)
{
  if (pID_ptr != kernel_ptr)
