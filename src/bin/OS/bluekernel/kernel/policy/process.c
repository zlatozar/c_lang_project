...
// @B-
// @C+
pID_t AddProcessCall(uint32_t priority, pID_t parent_pID, uint32_t first_instruction,
					 uint32_t user_stack_addr, uint32_t kernel_stack_addr,
					 pID_t excepter_pID, pID_t pager_pID)
{
	LockBus();
...
int32_t RemoveProcessCall(int32_t pID)
{
...
// @C-
// @G+ Get/Set Functions
uint32_t GetProcessCall(int32_t pID, uint32_t *properties)
{
