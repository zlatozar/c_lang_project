 ...
 */
int
CopyProcess(process_table_t* pID_ptr, uint32_t file_source, uint32_t file_size)
{
 ...
 */
uint16_t
CreateTssDescriptor(int processT_entry)
{
...
CreateInterruptGates(void)
{
  ...
  *desc16 = ((unsigned)DivideErrorExc)  & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)SingleStepExc)   & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)NmiExc)          & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)BpExc)           & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)OverflowExc)     & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)BoundsCheckExc)  & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)InvalidOpcodeExc) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)CoCpuExc)         & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)DoubleFaultExc)   & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)CoCpuOverrunExc)  & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)InvalidTssExc)    & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)SegNotPresentExc) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)StackExc)         & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)GenProtectionExc) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)PageFaultExc)     & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)CoCpuErrorExc)    & 0xFFFF;
  desc16 += 4;

  /* Hardware Interrupts */
  desc16  = (uint16_t*)(IDT_BASE + 0x20 * 8);

  *desc16 = ((unsigned)HwInt0) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt1) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt2) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt3) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt4) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt5) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt6) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt7) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt8) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt9) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt10) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt11) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt12) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt13) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt14) & 0xFFFF;
  desc16 += 4;

  *desc16 = ((unsigned)HwInt15) & 0xFFFF;
  desc16 += 4;
...
uint16_t
CreateGate(unsigned char type, unsigned offset, uint16_t selector, int priv,
           unsigned char word_count, unsigned table_base, uint16_t entry_no)
{
