...
// @P+
int
WritePort(uint32_t resource_num, uint32_t* data, int32_t port_type)
{
...
int
ReadPort(uint32_t resource_num, uint32_t* data, int32_t port_type)
{
  running_ptr->last_syscall = port_type;
  resource_num        -= PORT_PID_FIRST; // port index offset
