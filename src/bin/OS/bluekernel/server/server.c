...
pID_t
OpenFile(char* filename, pID_t parent_pID, uint32_t priority)
{
  int     add_thread      = 0;
...
int
LoadFile(char* filename, pID_t new_pID, unsigned load_address)
{
...
int
LoadBlocks(pID_t user_pID, uint32_t load_address, block_array blocks, uint32_t permissions)
{
