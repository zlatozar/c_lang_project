...
void
AddFileTableEntry(char* filename, int start, int size)
{
...
void
CreateBootTableEntry(char* filename, int priority_or_size)
{
  ...
  PrintLog(GREEN
           "Add boot entry: %s | block start 0x%x (0x%x) | end 0x%x (0x%x) | size in blocks 0x%x | first instruction 0x%x.\n"
           NORMAL,
